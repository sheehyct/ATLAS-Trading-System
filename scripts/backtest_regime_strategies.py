...
def backtest_regime_strategies(
    ...
    # Save metrics to CSV (organized in visualization directory)
    metrics_df = pd.DataFrame(metrics_data)
    metrics_df.to_csv('visualization/strategy_backtests/regime_strategies_metrics.csv', index=False)
    print(f"\n   Saved metrics: visualization/strategy_backtests/regime_strategies_metrics.csv")
    ...
    fig.write_html('visualization/strategy_backtests/regime_strategies_comparison.html')
    print(f"   Saved comparison chart: visualization/strategy_backtests/regime_strategies_comparison.html")
    ...
    for name, pf in results.items():
        ...
        tearsheet_path = f'visualization/strategy_backtests/{filename}_tearsheet.html'
    ...
    print(f"{'='*70}")
    print(f"\nGenerated files:")
    print(f"  1. visualization/strategy_backtests/regime_strategies_comparison.html (comparison chart)")
    print(f"  2. visualization/strategy_backtests/regime_strategies_metrics.csv (performance metrics)")
    print(f"  3. visualization/strategy_backtests/strategy_1_bull_only_tearsheet.html (Strategy 1 tearsheet)")
    print(f"  4. visualization/strategy_backtests/strategy_2_long_short_tearsheet.html (Strategy 2 tearsheet)")
    print(f"  5. visualization/strategy_backtests/strategy_3_conservative_tearsheet.html (Strategy 3 tearsheet)")
